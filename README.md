...
Os algoritmos estão organizados nas seguintes categorias:
...
* **Algoritmos de Ordenação:** Implementações práticas de métodos clássicos (Bubble Sort, Selection Sort, Insertion Sort).
* **Ponteiros:** Estudo sobre alocação de memória e manipulação de endereços.

## Tecnologias Utilizadas

* **Linguagem:** C / C++
* **Conceitos:** Lógica de Programação, Estruturas de Dados, Algoritmos Básicos.
